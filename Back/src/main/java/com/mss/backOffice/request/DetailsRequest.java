...
public class DetailsRequest {
  ...
  public List<String> transactionCode;
  ...
  public DetailsRequest(long drMinAmount, List<String> transactionCode, long drMaxAmount,
      String drAmountLimit, long drNumberLimit, Date drStartDate, Date drEndDate,
      long drCurrencyAmount, long drCurrencyNumber, String drTypePeriodicity) {
    this.drMinAmount = drMinAmount;
    this.transactionCode = transactionCode;
    this.drMaxAmount = drMaxAmount;
    this.drAmountLimit = drAmountLimit;
