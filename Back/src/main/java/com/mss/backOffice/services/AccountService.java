...
public class AccountService {
	...
	public AccountDetails getAccountDetails(String rib,String token)
		...
		return restTemplate.exchange(conn.path+"Api/Account/List/{rib}", HttpMethod.GET, entity,  AccountDetails.class,rib)
				.getBody();
