...
public class AccountBalance {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AccountBalance.class);
 

	public AccountBalance getAccountBalance(String rib,String token)
		...
		return restTemplate.exchange(conn.path+"Api/Account/Solde/{rib}", HttpMethod.GET, entity,  AccountBalance.class,rib)
				.getBody();
